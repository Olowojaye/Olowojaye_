...
const skills = [
  {
    name: "HTML",
    icon: `<svg width="36" height="36" viewBox="0 0 128 128">
              <path
                fill="#E44D26"
  ...
  {
    name: "CSS",
    icon: `<svg height="36" width="36" viewBox="0 0 128 128">
              <path
                fill="#131313"
...
const skillsContainer = document.querySelector("section#skills ul");

const skillsListItemsHtml = skills
  .map(function (skill) {
    const listItem = `<li>
  ${skill.icon}
  <p>${skill.name}</p>
...
skillsContainer.innerHTML = skillsListItemsHtml;
